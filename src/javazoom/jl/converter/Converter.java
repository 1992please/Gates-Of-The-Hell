...
/**
 * The
 * <code>Converter</code> class implements the conversion of an MPEG audio file
 * to a .WAV file. To convert an MPEG audio stream, just create an instance of
 * this class and call the convert() method, passing in the names of the input
 * and output files. You can pass in optional
 * <code>ProgressListener</code> and
...
public class Converter {
    ...
    static public interface ProgressListener {
         ...
         * UPDATE_CONVERT_COMPLETE: param1 is the conversion time, param2 is the
         ...
         *
         * @param	t	The <code>Throwable</code> instance that was thrown.
         *
         ...
         * <code>true</code> is returned, the exception is silently ignored and
         * the converter moves onto the next frame.
         */
    ...
    /**
     * Implementation of
     * <code>ProgressListener</code> that writes notification text to a
