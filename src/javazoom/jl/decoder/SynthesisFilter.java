...
//	float[] pp = new float[16];
     ...
     * @param blockSize	The size of the blocks to split the array into. This
     * must be an exact divisor of the length of the array, or some data will be
     ...
     * @param offs	The offset in the array that corresponds to the first index
     * of the subarray.
