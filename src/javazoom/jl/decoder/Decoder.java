...
/**
 * The
 * <code>Decoder</code> class encapsulates the details of decoding an MPEG audio
 * frame.
 *
 * @author	MDM
...
public class Decoder implements DecoderErrors {
    ...
    /**
     * Creates a new
     * <code>Decoder</code> instance with default parameters.
     */
    public Decoder() {
        this(null);
    }
     ...
     * stream.
     *
     * @param the sample rate (in Hz) of the samples written to the output
    ...
    /**
     * The
     * <code>Params</code> class presents the customizable aspects of the
     * decoder.
     * <p>
    ...
    public static class Params implements Cloneable {
         ...
         * <p>
         * The
         * <code>Equalizer</code> instance returned cannot be changed in real
         * time to affect the decoder output as it is used only to initialize
         * the decoders EQ settings. To affect the decoder's output in realtime,
         * use the Equalizer returned from the getEqualizer() method on the
         * decoder.
         *
