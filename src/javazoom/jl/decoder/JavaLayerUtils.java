...
public class JavaLayerUtils {
     ...
     * <code>InputStream</code>. The deserialization is delegated to an
     * <code>
     ...
     * underlying stream, or an object could not be deserialized from the
     * stream.
     *
     ...
     *
     * @param name	The name of the resource. This must be a simple name, and not
     * a qualified package name.
     *
     * @return	The InputStream for the named resource, or null if the resource
     * has not been found. If a hook has been provided, its
